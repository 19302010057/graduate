...
//    =================================用户个人信息管理================================
    ...
    public Map<String,Object> modifyUserInfo(@RequestParam(value = "account") String account,
                                            @RequestParam(value = "img")MultipartFile file,
                                             @RequestParam(value = "gender") String gender,
                                             @RequestParam(value = "name") String name,
                                             @RequestParam(value = "info") String info,
                                             @RequestParam(value = "isImg") Boolean isImg
                                             ){
        User user = userService.getUser(account);
        System.out.println("isImg--------------------"+isImg);
        if(isImg){
            System.out.println("里面----");
            FileUtil.delOneImg(basePath+user.getImgUrl());
            String imgName = UploadUtil.uploadFile(file,basePath);
