...
import com.store.entity.user.SecurityUser;
import com.store.entity.user.User;
import com.store.service.imp.UserService;
import com.store.util.JwtTokenUtil;
...
//        auth.inMemoryAuthentication().withUser("黄小龙").password("$2a$10$vEBSLD7Wy7UsF2raEtZa0e5uUg0HGOosxEycfLdJj4LtkMiQIZXpm").roles("user");
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.authorizeRequests()
                ...
                .antMatchers("/image/*", "/book/*", "/register","/sort/*","/topic/*","/user/register","/user/accountVerify")// 对登录注册要允许匿名访问
                .permitAll()
