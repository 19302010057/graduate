...
import com.store.entity.order.OrderStatusEnum;
...
public class OrderServiceImpl implements OrderService {
    ...
    public boolean addOrder(OrderInitDto orderInitDto) {
        ...
        for(OrderItemDto orderItemDto :orderInitDto.getItemList()){
            OrderDetail orderDetail = new OrderDetail();
            orderDetail.setItemId(orderItemDto.getId());
            orderDetail.setNum(orderItemDto.getNum());
            orderDetail.setPrice(orderItemDto.getPrice());
...
//            }
    ...
    @Transactional
    @Override
    public int deliverItem(int id, int logisticsCompany, String logisticsNum) {
