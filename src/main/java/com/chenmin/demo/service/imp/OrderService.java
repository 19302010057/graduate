...
import com.store.entity.dto.OrderDetailDto;
import com.store.entity.dto.OrderDto;
import com.store.entity.dto.OrderInitDto;
import com.store.entity.dto.OrderStatistic;
...
public interface OrderService {
    ...
    int deliverItem(int id, int logisticsCompany, String logisticsNum);//发货
