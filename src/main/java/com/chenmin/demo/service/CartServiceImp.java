...
import com.store.entity.user.Cart;
...
public class CartServiceImp implements CartService {
    ...
    @Override
    public List<CartItemDto> getCartsByPage(String account, int page, int pageSize) {
    ...
    @Override
    public int getItemCount(String account, int id) {
        return cartMapper.getItemCount(account, id);
    }
